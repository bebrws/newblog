...
I ran into a few interesting issues. Like problems [getting keyboard input after piping in input into STDIN](/post/stdin-after-pipe) or needing to write [my own fuzzy string search in nim](/posts/nim-fuzzy).
