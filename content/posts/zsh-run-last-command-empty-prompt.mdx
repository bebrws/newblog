...
So this script keeps track of the last non-empty command or ZSH prompt/buffer and runs it whenever I send a few empty lines by pressing the enter key 2 times in a row.
